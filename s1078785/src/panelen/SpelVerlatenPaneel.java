...
public class SpelVerlatenPaneel extends JPanel implements MouseListener{
	...
	public SpelVerlatenPaneel(Main main){
	...
	public void paintComponent(Graphics g){
		...
		g.drawImage(confirmtext,300,170,209,23,this);
	...
	public void mouseEntered(MouseEvent m) {
		System.out.println("Wil je het spel verlaten?");
